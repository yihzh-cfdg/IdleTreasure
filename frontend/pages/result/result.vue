	...
	<view>
		<view>
			<view style="display: flex;align-items: center;margin: 20rpx;height: 52rpx;">
				...
				<view style="flex: 1;">
					<view
						style="background-color: white;border: 1px solid black;height: 52rpx;border-radius: 30rpx;padding: 0 20rpx;display: flex;">
						<view class="uni-input-wrapper">
							<input class="uni-input"  :value="inputValue" @input="changeInput" />
							<icon type="clear" size="20" v-if="showClearIcon" @click="clearIcon"/>
						</view>
					</view>
				</view>
			</view>
