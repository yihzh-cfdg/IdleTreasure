<template>
	<view class="container">
		...
		<uni-popup ref="inputRecipient" type="dialog">
		  <uni-popup-dialog mode="input" title="修改收货人" :value="addressInfo.recipient" :before-close="true" @close="closeRecipientInput" @confirm="confirmRecipientInput" />
		</uni-popup>
		
		<uni-popup ref="inputPhoneNumber" type="dialog">
		  <uni-popup-dialog mode="input" title="修改电话号码" :value="addressInfo.phoneNumber" :before-close="true" @close="closePhoneNumberInput" @confirm="confirmPhoneNumberInput" />
		</uni-popup>
		
		<uni-popup ref="inputAddress" type="dialog">
		  <uni-popup-dialog mode="input" title="修改收货地址" :value="addressInfo.address" :before-close="true" @close="closeAddressInput" @confirm="confirmAddressInput" />
		</uni-popup>
	</view>
</template>
